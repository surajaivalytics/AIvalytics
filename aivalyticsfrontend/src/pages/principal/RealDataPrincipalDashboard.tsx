...
const RealDataPrincipalDashboard: React.FC = () => {
 ...
 <div className="absolute -top-40 -right-40 w-80 h-80 bg-gray-50 dark: rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse"></div>
 ...
 <div className="absolute top-40 left-40 w-80 h-80 bg-gray-50 dark: rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse"></div>
 </div>
 ...
 isDark,
 "bg-gray-50 dark: border-blue-200 dark:border-blue-800",
 " border-blue-700"
 )}`}
 >
 <span
