...
const styles = `
 ...
 .metric-card {
 background: rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.05) 100%);
 ...
 background: rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.1) 100%);
 ...
 background: #3B82F6 0%, rgba(239, 68, 68, 0.05) 100%);
 border-radius: 16px;
 }
 
 .priority-medium {
 border-left: 4px solid #F59E0B;
 background: #3B82F6 0%, rgba(245, 158, 11, 0.05) 100%);
 border-radius: 16px;
 }

 .priority-low {
 border-left: 4px solid #10B981;
 background: #3B82F6 0%, rgba(16, 185, 129, 0.05) 100%);
 border-radius: 16px;
 }
 ...
 .nav-tab:hover {
 background: rgba(59, 130, 246, 0.1), rgba(139, 92, 246, 0.1));
 ...
 .data-table {
 background: rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.02) 100%);
 backdrop-filter: blur(10px);
 border: 1px solid rgba(255, 255, 255, 0.1);
 border-radius: 24px;
 overflow: hidden;
 ...
 .dark .data-table {
 background: rgba(17, 24, 39, 0.8) 0%, rgba(17, 24, 39, 0.6) 100%);
 ...
 background: rgba(59, 130, 246, 0.1), rgba(139, 92, 246, 0.2));
 }
 ...
 .executive-header {
 background: rgba(59, 130, 246, 0.1) 0%, rgba(139, 92, 246, 0.1) 100%);
 backdrop-filter: blur(20px);
 border: 1px solid rgba(255, 255, 255, 0.1);
 border-radius: 32px;
 padding: 3rem;
 ...
 background: rgba(17, 24, 39, 0.8) 0%, rgba(31, 41, 55, 0.9) 100%);
 border: 1px solid rgba(255, 255, 255, 0.05);
 }
 
 .metric-icon {
 background: #3B82F6, var(--icon-color-2));
 border-radius: 16px;
 padding: 16px;
 ...
 .department-badge {
 background: #3B82F6, var(--badge-color-2));
 color: white;
 padding: 6px 16px;
 border-radius: 20px;
 font-size: 0.875rem;
 ...
 .loading-shimmer {
 background: rgba(255, 255, 255, 0.05) 0%,
...
const PrincipalDashboard: React.FC = () => {
 ...
 {/* Loading Header */}
 <div className="relative overflow-hidden bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50 shadow-sm backdrop-blur-xl mb-8">
 <div className="absolute inset-0 dark:bg-blue-500/[0.05]"></div>
 ...
 <div
 key={index}
 className="relative overflow-hidden bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50 shadow-sm backdrop-blur-xl p-6"
 >
 <div className="space-y-4">
 <div className="flex items-center justify-between">
 ...
 {/* Loading Table */}
 <div className="relative overflow-hidden bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50 shadow-sm backdrop-blur-xl">
 <div className="p-6">
 ...
 <div className="flex items-center gap-3 px-4 py-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-lg backdrop-blur-xl border border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50">
 <div className="h-2 w-2 bg-gray-50 dark: rounded-full loading-pulse"></div>
 ...
 <div className="text-center px-4 py-3 rounded-lg bg-gray-50 dark:/50 dark: border border-blue-100/50 dark:border-blue-800/50">
 ...
 <div className="text-xs text-blue-600 dark:text-blue-400/70 dark:text-blue-300/70">All Systems Operational</div>
 </div>
 <div className="text-center px-4 py-3 rounded-lg bg-gray-50/50 dark: border border-purple-100/50 dark:border-purple-800/50">
 ...
 <Card key={index} className="relative overflow-hidden bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50">
 <div className="absolute inset-0 bg-gray-500/5 dark:bg-white/[0.02]"></div>
 ...
 <Card className="relative overflow-hidden bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50">
 <div className="absolute inset-0 bg-blue-500/[0.02] dark:bg-blue-500/[0.02]"></div>
 <CardHeader className="relative border-b border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50">
 <div className="flex items-center justify-between">
 <CardTitle className="text-lg font-semibold flex items-center gap-2">
 <ChartBarIcon className="h-5 w-5 text-blue-500 dark:text-blue-400" />
 <span className="text-blue-600 dark:bg-blue-400 ">
 Department Performance Matrix
 </span>
 </CardTitle>
 <div className="flex gap-3">
 <Badge variant="outline" className="font-normal bg-gray-50 dark:/50 dark: text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800/50 dark:border-blue-800/50">
 Current Semester
 </Badge>
 <Badge variant="outline" className="font-normal bg-gray-50 dark:bg-gray-800/50/50 dark:bg-gray-900/20 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-700/50 dark:border-gray-800/50">
 View Analytics
 </Badge>
 </div>
 </div>
 ...
 <thead>
 <tr className="border-b border-gray-200 dark:border-gray-700/50 dark:border-gray-700/50">
 ...
 <tr key={index} className="hover:bg-gray-50 dark:bg-gray-800/50/50 dark:hover:bg-gray-700/50 transition-colors">
 ...
 <Badge variant="outline" className="bg-gray-50/50 dark: text-purple-700 dark:text-purple-300 border-purple-200/50 dark:border-purple-800/50">
 ...
 isDark,
 "bg-white/80 shadow-2xl border border-gray-200 dark:border-gray-700",
 "bg-gray-800/80 border border-gray-700"
 )}`}>
 <div className="flex items-center justify-between mb-8">
 <div>
 <h2 className={`text-3xl font-bold ${getThemedClasses(isDark, "text-gray-900 dark:text-white", "text-white")} mb-2`}>
 Strategic Alerts & Action Items
 </h2>
 <p className={`text-sm ${getThemedClasses(isDark, "text-gray-600 dark:text-gray-400", "text-gray-400")}`}>
 ...
 isDark,
 "text-blue-600 dark:text-blue-400 hover:bg-gray-50 dark:",
 "text-blue-400 hover:"
 )}`}>
 View All Alerts
 </button>
 ...
 alert.priority === 'high' 
 ? 'bg-red-100 text-red-600 dark: dark:text-red-400' 
 : 'bg-yellow-100 text-yellow-600 dark: dark:text-yellow-400'
 }`}>
 <ExclamationTriangleIcon className="h-6 w-6" />
 </div>
 <div>
 <h3 className={`text-xl font-bold ${getThemedClasses(isDark, "text-gray-900 dark:text-white", "text-white")} mb-1`}>
 {alert.title}
 </h3>
 <div className="flex items-center space-x-4">
 <span className={`text-xs px-3 py-1 rounded-full font-semibold ${
 alert.priority === 'high'
 ? 'bg-red-100 text-red-800 dark: dark:text-red-300'
 : 'bg-yellow-100 text-yellow-800 dark: dark:text-yellow-300'
 }`}>
 {alert.category}
 </span>
 <span className={`text-xs ${getThemedClasses(isDark, "text-gray-500 dark:text-gray-400", "text-gray-400")}`}>
 Due: {alert.deadline}
 </span>
 <span className={`text-xs ${getThemedClasses(isDark, "text-gray-500 dark:text-gray-400", "text-gray-400")}`}>
 {alert.department}
 ...
 alert.priority === 'high' ? 'text-red-600 dark:text-red-400' : 'text-yellow-600 dark:text-yellow-400'
 }`}>
 {alert.urgency}
 </span>
 </div>
 ...
 <p className={`text-base ${getThemedClasses(isDark, "text-gray-700 dark:text-gray-300", "text-gray-300")} ml-16`}>
 {alert.description}
 </p>
 </div>
 ...
 <div className="flex-1">
 <h3 className={`text-xl font-bold ${getThemedClasses(isDark, "text-gray-900 dark:text-white", "text-white")} mb-2`}>
 {insight.title}
 </h3>
 <div className={`text-xs px-3 py-1 rounded-full font-semibold inline-block mb-3 ${
 insight.riskLevel === 'Low' 
 ? 'bg-green-100 text-green-800 dark: dark:text-green-300'
 ...
 <p className={`text-sm ${getThemedClasses(isDark, "text-gray-700 dark:text-gray-300", "text-gray-300")} mb-6`}>
 {insight.description}
 </p>
 
 <div className="space-y-4 mb-6">
 <div className="flex justify-between items-center">
 <span className={`text-sm font-medium ${getThemedClasses(isDark, "text-gray-600 dark:text-gray-400", "text-gray-400")}`}>
 Investment Required:
 </span>
 <span className={`text-sm font-bold ${getThemedClasses(isDark, "text-gray-900 dark:text-white", "text-white")}`}>
 ...
 <div className={`text-sm ${getThemedClasses(isDark, "text-blue-600 dark:text-blue-400", "text-blue-400")} mb-6 italic p-4 rounded-lg ${getThemedClasses(
 isDark,
 "bg-gray-50 dark:",
 ""
 )}`}>
 ...
 isDark,
 "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-200",
 "bg-gray-600 text-gray-300 hover:bg-gray-50 dark:bg-gray-800/500"
 )}`}>
 Detailed Analysis
 </button>
 ...
 isDark,
 "bg-white/90 border-gray-200 dark:border-gray-700 shadow-lg",
 "bg-gray-800/90 border-gray-700 shadow-lg"
 )}`}>
 <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="flex items-center justify-between h-16">
 <h1 className="text-xl font-semibold text-gray-900 dark:bg-white ">
 Principal Dashboard
 </h1>
