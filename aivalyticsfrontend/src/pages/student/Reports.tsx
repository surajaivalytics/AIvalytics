...
const Reports: React.FC = () => {
 ...
 <div className="bg-gray-50 dark: p-4 rounded-lg border border-blue-200 dark:border-blue-800">
 <div className="flex items-center gap-2">
 ...
 <div className="bg-gray-50 dark: p-4 rounded-lg border border-green-200 dark:border-green-800">
 <div className="flex items-center gap-2">
 ...
 <div className="bg-gray-50 dark: p-4 rounded-lg border border-purple-200 dark:border-purple-800">
 <div className="flex items-center gap-2">
 ...
 <div className="bg-gray-50 dark: rounded-lg p-4">
 <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
 ...
 <div
 key={index}
 className="bg-green-100 dark: p-3 rounded-lg"
 >
 <div className="flex justify-between items-center">
 ...
 <div
 key={index}
 className="bg-red-100 dark: p-3 rounded-lg"
 >
 <div className="flex justify-between items-center">
 ...
 <div
 key={index}
 className="bg-purple-100 dark: p-3 rounded-lg"
 >
 ...
 {selectedReport.report_data.aiSuggestions
 .motivationalMessage && (
 <div className="mt-4 p-3 bg-purple-100 dark: rounded-lg">
 <h4 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">
