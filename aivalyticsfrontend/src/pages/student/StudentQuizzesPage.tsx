...
const StudentQuizzesPage: React.FC = () => {
 ...
 if (newWarnings >= 3) {
 toast.error("Maximum warnings reached. Quiz will be auto-submitted.");
 handleSubmitQuiz();
 } else {
 toast.error(`Warning ${newWarnings}/3: ${message}`, { duration: 5000 });
 }
 return newWarnings;
 });
 }, [handleSubmitQuiz]);

 // Anti-cheating: detect tab switch, window blur, copying, exiting fullscreen
 useEffect(() => {
 if (!takingQuiz || submitting) return;

 const handleVisibilityChange = () => {
 if (document.hidden) {
 handleWarning("You switched tabs. This is considered suspicious behavior.");
 }
 };

 const handleBlur = () => {
 handleWarning("You clicked outside the quiz window. Please stay focused.");
 };
 ...
 handleWarning("You exited fullscreen mode. Please return to fullscreen.");
 try {
 ...
 }, [takingQuiz, submitting, handleWarning]);
 ...
 <div className="absolute inset-0 dark: rounded-2xl blur-xl transition-all duration-300 group-hover:scale-105 opacity-0 group-hover:opacity-100"></div>
 ...
 <div className="absolute inset-0 bg-blue-500/[0.05] dark:bg-blue-500/[0.02]"></div>
 <div className="relative p-6">
 <div className="flex items-start gap-4">
 <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-blue-500 p-2.5">
 ...
 <span className="px-2.5 py-1 text-xs font-medium bg-gray-50/50 dark: text-blue-700 dark:text-blue-300 rounded-full border border-blue-100/50 dark:border-blue-800/50">
 {quiz.question_count} Questions
 </span>
 <span className="px-2.5 py-1 text-xs font-medium bg-gray-50/50 dark: text-purple-700 dark:text-purple-300 rounded-full border border-purple-100/50 dark:border-purple-800/50">
 ...
 <button
 onClick={onStart}
 className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-300"
 >
 ...
 <div className="absolute top-0 right-0 w-2/3 h-2/3 dark: blur-3xl transform -translate-y-1/4 translate-x-1/4 rounded-full"></div>
 <div className="absolute bottom-0 left-0 w-2/3 h-2/3 dark: blur-3xl transform translate-y-1/4 -translate-x-1/4 rounded-full"></div>
 </div>
 ...
 {/* Score Card */}
 <div className="relative group">
 <div className="absolute inset-0 rounded-xl blur-lg transition-opacity duration-300 opacity-0 group-hover:opacity-100"></div>
 ...
 <div className="relative group">
 <div className="absolute inset-0 bg-emerald-500/20 rounded-xl blur-lg transition-opacity duration-300 opacity-0 group-hover:opacity-100"></div>
 <div className="relative overflow-hidden bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl border border-gray-200/50 dark:border-gray-700/50 p-6 transition-all duration-300 hover:shadow-lg">
 <div className="flex flex-col items-center">
 ...
 className="group relative inline-flex items-center px-8 py-3 text-lg font-semibold text-white bg-blue-600 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
 >
 ...
 <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-blue-100 dark: flex items-center justify-center">
 ...
 ? "bg-gray-50/50 dark: border-red-200 dark:border-red-800 text-red-700 dark:text-red-300"
 ...
 {result.explanation && (
 <div className="mt-4 p-4 bg-gray-50/50 dark: rounded-lg border border-blue-200/50 dark:border-blue-800/50">
 ...
 {/* Warnings Card */}
 {warnings > 0 && (
 <div className="relative overflow-hidden dark: backdrop-blur-sm rounded-xl border border-red-200/50 dark:border-red-800/50 p-4">
 <div className="text-center">
 ...
 <div className="flex-shrink-0 w-10 h-10 bg-blue-100 dark: rounded-lg flex items-center justify-center">
 ...
 ? "border-blue-500 bg-gray-50/50 dark:"
 : "border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-500 hover:bg-gray-50/30 dark:hover:"
 }
 `}
 >
 <div className="flex items-center">
 ...
 : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 group-hover:bg-blue-100 dark:group-hover: group-hover:text-blue-600 dark:group-hover:text-blue-400"
 }
 `}>
 ...
 disabled={submitting}
 className="group relative inline-flex items-center px-8 py-3 text-sm font-medium text-white bg-emerald-600 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:transform-none"
 >
 {submitting ? (
 <>
 ...
 className="group relative inline-flex items-center px-8 py-3 text-sm font-medium text-white bg-blue-600 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
 >
 ...
 {/* Background Effects */}
 <div className="absolute inset-0 overflow-hidden pointer-events-none">
 <div className="absolute top-0 right-0 w-1/2 h-1/2 blur-3xl transform -translate-y-1/4 translate-x-1/4 rounded-full"></div>
 <div className="absolute bottom-0 left-0 w-1/2 h-1/2 blur-3xl transform translate-y-1/4 -translate-x-1/4 rounded-full"></div>
 </div>
 ...
 <div className=" bg-blue-600 p-4 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
 ...
 disabled={loading}
 className="group relative inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:transform-none"
 >
 {loading ? (
 <>
