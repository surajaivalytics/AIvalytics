...
const Courses: React.FC = () => {
 ...
 <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl animate-pulse-slow "></div>
 <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl animate-pulse-slow "></div>
 <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 w-full h-96 blur-3xl"></div>
 </div>
 ...
 <div className=" bg-indigo-500 p-4 rounded-xl shadow-lg animate-float">
 ...
 <button
 type="submit"
 className="px-6 py-3 bg-indigo-500 text-white font-medium rounded-xl hover:bg-indigo-600 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
 >
 Search
 </button>
 </form>
 ...
 <div className=" bg-indigo-500 p-4 rounded-full w-16 h-16 mx-auto mb-6 animate-float">
