...
import RealDataStudentDashboard from "./student/RealDataStudentDashboard";
import RealDataTeacherDashboard from "./teacher/RealDataTeacherDashboard";
import RealDataHodDashboard from "./hod/RealDataHodDashboard";
import RealDataPrincipalDashboard from "./principal/RealDataPrincipalDashboard";
...
const DashboardComparison: React.FC = () => {
 ...
 <div className="h-10 w-10 flex items-center justify-center rounded-xl bg-blue-600 shadow-lg">
 <svg
 ...
 <div>
 <h1 className="text-lg font-bold bg-gray-900 dark:bg-white text-transparent">
 Dashboard
 </h1>
 ...
 useRealData
 ? " bg-gray-50/90 border-blue-200/50"
