...
const Achievements: React.FC = () => {
 ...
 <div className={`h-12 w-12 rounded-full ${achievement.color} flex items-center justify-center mr-4 ${!achievement.earned && 'opacity-60'}`}>
 ...
 <div className="px-3 py-1 text-yellow-400 rounded-full text-xs font-medium border border-yellow-800/30">
