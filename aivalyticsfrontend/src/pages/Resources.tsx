    ...
    <Layout>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-blue-900/30 rounded-xl p-4 border border-blue-800/50 flex items-center justify-between">
            <div className="flex items-center">
              <DocumentTextIcon className="h-6 w-6 text-blue-400 mr-3" />
              <span className="text-white font-medium">Documents</span>
            </div>
            <span className="bg-blue-800/50 text-blue-300 rounded-full px-2 py-1 text-xs">24</span>
          </div>
          
          <div className="bg-red-900/30 rounded-xl p-4 border border-red-800/50 flex items-center justify-between">
            <div className="flex items-center">
              <VideoCameraIcon className="h-6 w-6 text-red-400 mr-3" />
              <span className="text-white font-medium">Videos</span>
            </div>
            <span className="bg-red-800/50 text-red-300 rounded-full px-2 py-1 text-xs">16</span>
          </div>
          
          <div className="bg-green-900/30 rounded-xl p-4 border border-green-800/50 flex items-center justify-between">
            <div className="flex items-center">
              <BookOpenIcon className="h-6 w-6 text-green-400 mr-3" />
              <span className="text-white font-medium">Books</span>
            </div>
            <span className="bg-green-800/50 text-green-300 rounded-full px-2 py-1 text-xs">8</span>
          </div>
          
          <div className="bg-purple-900/30 rounded-xl p-4 border border-purple-800/50 flex items-center justify-between">
            <div className="flex items-center">
              <PuzzlePieceIcon className="h-6 w-6 text-purple-400 mr-3" />
              <span className="text-white font-medium">Interactive</span>
            </div>
            <span className="bg-purple-800/50 text-purple-300 rounded-full px-2 py-1 text-xs">12</span>
          </div>
        </div>
