    ...
    <div className="min-h-screen bg-[#F3F4F6] text-slate-900 font-sans">
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 min-h-[600px] overflow-hidden">
                      ...
                      <tr key={student.roll} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="px-8 py-5 text-right">
                          <div className="flex gap-2 justify-end">
                            <button onClick={() => markAttendance(student.roll, "Present")} className="p-2 border rounded-xl text-green-600 hover:bg-green-50"><CheckIcon className="h-5 w-5"/></button>
                            <button onClick={() => markAttendance(student.roll, "Absent")} className="p-2 border rounded-xl text-red-600 hover:bg-red-50"><XMarkIcon className="h-5 w-5"/></button>
                          </div>
                        </td>
                      </tr>
                    ))}
          ...
          {/* 5. LEAVE TAB */}
          {activeTab === "Leave" && (
            <div className="p-12 max-w-3xl mx-auto space-y-8 animate-in slide-in-from-bottom-8">
