...
const HodDashboard: React.FC = () => {
 ...
 <div className="h-20 w-20 bg-purple-500 rounded-full flex items-center justify-center shadow-lg">
 ...
 <div className="flex items-center">
 <div
 className={` ${stat.color} rounded-xl p-3 shadow-lg`}
 >
 ...
 isDark,
 "bg-gray-50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:bg-gray-700",
 ...
 isDark,
 "bg-yellow-100 text-yellow-800 border-yellow-200 dark:border-yellow-800",
 ...
 ? isDark
 ? "bg-red-100 text-red-800 border border-red-200 dark:border-red-800"
 : "bg-red-900 text-red-300 border border-red-700"
 : approval.priority === "medium"
 ? isDark
 ? "bg-yellow-100 text-yellow-800 border border-yellow-200 dark:border-yellow-800"
 : "bg-yellow-900 text-yellow-300 border border-yellow-700"
 : isDark
 ? "bg-green-100 text-green-800 border border-green-200 dark:border-green-800"
 ...
 ? "bg-gray-50 dark:"
 : "bg-gray-50 dark:bg-gray-800/500"
 }`}
 ></div>
 ...
 isDark,
 "text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white hover:border-gray-300",
