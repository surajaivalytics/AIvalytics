        ...
        <div className={`min-h-screen ${getThemedClasses(isDark, "bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200", "bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900")}`}>
          ...
          <div className="breadcrumb">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300">
          ...
          <div className="departments-header">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 tracking-tight mb-2">
                    Department Management
                  </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Badge variant="outline" className="py-2 px-4 bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200/50 dark:border-blue-800/50">
                  <CalendarIcon className="h-4 w-4 mr-2" />
                  Academic Year 2023-24
                </Badge>
                <Badge variant="outline" className="py-2 px-4 bg-green-50/50 dark:bg-green-900/20 text-green-700 dark:text-green-300 border-green-200/50 dark:border-green-800/50">
