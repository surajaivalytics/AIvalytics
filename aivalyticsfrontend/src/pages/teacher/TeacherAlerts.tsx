...
const TeacherAlerts: React.FC = () => {
 ...
 {alert.type === 'warning' && (
 <div className="h-10 w-10 rounded-full bg-orange-100 dark: flex items-center justify-center text-orange-600 dark:text-orange-400">
 <ExclamationCircle className="h-5 w-5" />
 </div>
 )}
 {alert.type === 'info' && (
 <div className="h-10 w-10 rounded-full bg-blue-100 dark: flex items-center justify-center text-blue-600 dark:text-blue-400">
 <Info className="h-5 w-5" />
 </div>
 )}
 {alert.type === 'success' && (
 <div className="h-10 w-10 rounded-full bg-green-100 dark: flex items-center justify-center text-green-600 dark:text-green-400">
