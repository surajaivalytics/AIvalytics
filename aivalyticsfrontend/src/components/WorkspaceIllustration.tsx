  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center p-6 sm:p-8">
      <div className="relative w-full max-w-lg aspect-square">
        ...
        <div className="relative w-full h-full bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/30 rounded-3xl p-4 sm:p-6 shadow-2xl border border-purple-200/30 dark:border-purple-700/20 overflow-hidden">
          
          {/* White Back Wall */}
          <div className="absolute inset-0 bg-white dark:bg-gray-50 rounded-3xl z-0"></div>
          
          {/* Light Purple Floor with Blue Border */}
          <div className="absolute bottom-0 left-0 right-0 h-2/5 bg-purple-100 dark:bg-purple-800/30 rounded-b-3xl border-t-4 border-blue-400 dark:border-blue-500 z-10"></div>
          ...
          <div className="absolute top-12 right-6 sm:right-8 space-y-4 z-20">
            ...
            <div className="flex items-end gap-3">
              ...
              <div className="flex gap-2">
                <div className="w-8 h-10 bg-blue-100 dark:bg-blue-900/50 rounded border-2 border-blue-300 dark:border-blue-600 shadow-sm"></div>
                <div className="w-8 h-10 bg-purple-100 dark:bg-purple-900/50 rounded border-2 border-purple-300 dark:border-purple-600 shadow-sm"></div>
              </div>
            </div>
          ...
          <div className="absolute bottom-36 right-5 sm:right-6 flex flex-col items-center z-20">
            ...
            <div className="w-11 h-14 bg-white dark:bg-gray-200 rounded-t-full shadow-xl border-2 border-gray-200 dark:border-gray-300 relative">
              {/* Warm Glow */}
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-yellow-200/50 dark:bg-yellow-800/40 rounded-full blur-xl"></div>
            </div>
            {/* Silver Pole */}
              ...
              <div className="absolute inset-0 p-3 sm:p-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="w-24 sm:w-28 h-16 sm:h-20 bg-purple-700 dark:bg-purple-800 rounded-lg shadow-xl border-2 border-purple-800 dark:border-purple-900 relative">
                    <div className="w-full h-full bg-purple-900/50 rounded-lg flex items-center justify-center p-1">
                      <div className="w-full h-full bg-blue-400/20 dark:bg-blue-500/20 rounded"></div>
                    </div>
                  </div>
