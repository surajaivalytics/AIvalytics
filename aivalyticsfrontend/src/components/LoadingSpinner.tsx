...
const SciFiSpinner: React.FC<{
 ...
 <div
 className={`w-full h-full rounded-full border-2 border-transparent ${gradientClass} opacity-60`}
 style={{
 ...
 <div
 className={`w-full h-full rounded-full ${gradientClass} opacity-80 blur-sm`}
 ></div>
 </div>
 ...
 <div
 className={`w-full h-full rounded-full ${gradientClass}`}
 ></div>
 </div>

 {/* Glow effect */}
 <div
 className={`absolute inset-0 rounded-full ${gradientClass} opacity-20 blur-md animate-pulse`}
 ></div>
 </div>
 );
};
