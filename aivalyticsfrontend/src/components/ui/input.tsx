...
const Input = forwardRef<HTMLInputElement, InputProps>(
 ...
 if (error) {
 return `${baseClasses} border-2 border-red-400 dark:border-red-500 bg-gray-50/50 dark: text-gray-900 dark:text-white focus:ring-red-500 focus:border-red-500 dark:focus:border-red-400`;
 }

 if (success) {
 return `${baseClasses} border-2 border-green-400 dark:border-green-500 bg-gray-50/30 dark: text-gray-900 dark:text-white focus:ring-green-500 focus:border-green-500 dark:focus:border-green-400`;
 }

 if (isFocused) {
 return `${baseClasses} border-2 border-blue-500 dark:border-blue-400 bg-gray-50/50 dark: text-gray-900 dark:text-white focus:ring-blue-500 dark:focus:ring-blue-400 shadow-sm`;
 }
