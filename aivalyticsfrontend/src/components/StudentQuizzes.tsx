...
const StudentQuizzes: React.FC<StudentQuizzesProps> = ({
 ...
 isDark
 ? " bg-green-600 text-white hover:bg-green-700 focus:ring-green-500 focus:ring-offset-gray-800 disabled:bg-gray-600 disabled:"
 : " bg-green-500 text-white hover:bg-green-600 focus:ring-green-500 focus:ring-offset-white disabled:bg-gray-400 disabled:"
