...
const AttendanceRecord: React.FC<AttendanceRecordProps> = ({ 
  ...
  const getCircleColor = (percentage: number) => {
    if (percentage >= 95) return 'from-green-400 to-emerald-500';
    if (percentage >= 85) return 'from-green-500 to-teal-500';
    if (percentage >= 75) return 'from-teal-500 to-cyan-500';
