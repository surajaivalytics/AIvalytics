...
const AIConceptHeatmap: React.FC = () => {
 ...
 <div className="absolute inset-0 bg-purple-500/[0.02] dark:bg-purple-500/[0.02]"></div>
 ...
 <Badge variant="outline" className="font-normal bg-gray-50/50 dark: text-purple-700 dark:text-purple-300 border-purple-200/50 dark:border-purple-800/50">
 AI Heatmap
 </Badge>
 </div>
 </CardHeader>
