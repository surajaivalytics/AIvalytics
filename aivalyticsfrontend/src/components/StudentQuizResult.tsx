              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    {userAnswer?.is_correct ? (
                      <div className="flex-shrink-0 ml-4 p-2 bg-green-100 dark:bg-green-800/50 rounded-full">
                        <CheckCircleIcon className="h-8 w-8 text-green-500" />
                      </div>
                    ) : (
                      <div className="flex-shrink-0 ml-4 p-2 bg-red-100 dark:bg-red-800/50 rounded-full">
                  ...
                  {question.explanation && (
                    <div className="mt-6 p-4 bg-blue-50 dark:bg-gray-800/60 rounded-lg border-l-4 border-blue-500">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="flex items-center px-2 py-1 text-xs font-semibold text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/50 rounded-md hover:bg-blue-200 dark:hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed"
                            disabled={
