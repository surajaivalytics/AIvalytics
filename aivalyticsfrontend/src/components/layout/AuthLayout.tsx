...
const AuthLayout: React.FC<AuthLayoutProps> = ({
 ...
 <div className="w-full lg:w-1/2 flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
 ...
 <div className="mx-auto h-16 w-16 bg-blue-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg transform hover:scale-105 transition-transform duration-200">
