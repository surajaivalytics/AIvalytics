...
const TeacherAttendance: React.FC = () => {
 ...
 <div>
 <h2 className="text-xl font-semibold text-blue-600 dark:bg-blue-400 ">
 ...
 <div className="flex items-center gap-2 px-4 py-2 bg-gray-50/50 dark: rounded-lg border border-blue-100/50 dark:border-blue-800/50">
 ...
 {/* Course Selection */}
 <div className="relative overflow-hidden bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl border border-gray-200/50 dark:border-gray-700/50">
 <div className="absolute inset-0 bg-emerald-500/5 dark:bg-emerald-500/[0.05]"></div>
 <div className="relative p-6">
 ...
 {selectedSession && (
 <div className="mt-4 p-4 bg-gray-50/50 dark: rounded-lg border border-blue-100/50 dark:border-blue-800/50">
 <div className="flex items-center justify-between">
 <div>
 <h4 className="font-medium text-gray-900 dark:text-white">
 ...
 disabled={loading}
 className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-medium px-6 py-3 rounded-lg shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-emerald-500/25"
 >
 {loading ? (
 ...
 <div className="relative">
 <div className="w-20 h-20 dark: rounded-full flex items-center justify-center mx-auto mb-4">
