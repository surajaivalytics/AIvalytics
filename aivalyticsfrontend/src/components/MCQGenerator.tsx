...
const MCQGenerator: React.FC = () => {
 ...
 {/* Course Selector - Common for both tabs */}
 <div>
 <label htmlFor="course_select" className={labelCls}>
 Select Course
 </label>
 <select
 id="course_select"
 ...
 "border-gray-600 hover:border-indigo-500 hover:"
 )
 }`}
 >
 <div
 ...
 "text-gray-500 hover:text-red-400 hover:"
 )}`}
 >
...
const QuizCard: React.FC<{
 ...
 className={`p-1.5 rounded-lg transition ${getThemedClasses(
 isDark,
 "text-orange-500 hover:bg-gray-50",
