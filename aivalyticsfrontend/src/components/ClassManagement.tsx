    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-indigo-700 flex items-center gap-2 shadow-lg transition-all duration-200"
        >
              ...
              <form onSubmit={handleCreateClass} className="space-y-4">
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg hover:from-purple-700 hover:to-indigo-700 disabled:opacity-50 transition-all duration-200"
                  >
            ...
            <div className="mt-3 text-center">
              ...
              <div className="flex justify-center gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-700 rounded-lg hover:from-red-700 hover:to-red-800 disabled:opacity-50 transition-all duration-200"
                >
            ...
            <div className="mt-3">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-3 py-1 rounded-lg hover:from-green-700 hover:to-emerald-700 flex items-center gap-2 transition-all duration-200 shadow-md"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg hover:from-green-700 hover:to-emerald-700 disabled:opacity-50 transition-all duration-200"
                  >
