...
const TeacherAttendance: React.FC = () => {
 ...
 case "absent":
 return "bg-red-100 text-red-800 border-red-200 dark: dark:text-red-400 dark:border-red-700";
 case "late":
 return "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-700";
 case "excused":
 return "bg-blue-100 text-blue-800 border-blue-200 dark: dark:text-blue-400 dark:border-blue-700";
 default:
 ...
 <div className="p-2 bg-green-100 dark: rounded-lg">
 ...
 className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl shadow-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
 >
 {creatingSession ? (
 <>
 ...
 <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
 <div className="flex items-center gap-3 mb-4">
 <div className="p-2 bg-purple-100 dark: rounded-lg">
 ...
 <div className="flex items-center gap-3 mb-4">
 <div className="p-2 bg-blue-100 dark: rounded-lg">
 ...
 {selectedSession && (
 <div className="mt-6 p-4 bg-gray-50 dark: rounded-xl border border-blue-200 dark:border-blue-700">
 <div className="flex items-center justify-between">
 <div>
 ...
 disabled={loading}
 className="w-full bg-green-600 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:bg-green-700 transform hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-green-100 dark:focus:ring-green-900/30 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 <div className="w-24 h-24 bg-blue-100 dark: rounded-full flex items-center justify-center mx-auto mb-6">
