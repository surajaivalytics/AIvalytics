...
const CourseCard: React.FC<CourseCardProps> = ({
 ...
 className="w-full py-2 px-3 hover:bg-indigo-600 text-white rounded-lg transition-all duration-200 flex items-center justify-center text-sm font-medium backdrop-blur-sm group-hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]"
 >
 ...
 onClick={onEnroll}
 disabled={enrolling}
 className="w-full py-2 px-3 hover:bg-red-600 text-white rounded-lg transition-all duration-200 flex items-center justify-center text-sm font-medium backdrop-blur-sm group-hover:shadow-[0_0_15px_rgba(239,68,68,0.3)]"
 >
 {enrolling ? (
 ...
 className="flex-1 py-2 px-3 hover:bg-blue-600 text-white rounded-lg transition-all duration-200 flex items-center justify-center text-sm font-medium backdrop-blur-sm group-hover:shadow-[0_0_15px_rgba(59,130,246,0.3)]"
 >
 ...
 disabled={deleting}
 className="flex-1 py-2 px-3 hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-all duration-200 flex items-center justify-center text-sm font-medium backdrop-blur-sm group-hover:shadow-[0_0_15px_rgba(239,68,68,0.3)]"
 >
 {deleting ? (
 <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>
 ) : (
